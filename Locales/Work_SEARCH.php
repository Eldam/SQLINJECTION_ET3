<meta charset="utf-8">
<link rel="stylesheet" href="../Locales/Work_SEARCH.css">
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">


<div class="SearchFormContainer">

    <form action="../Controllers/Work_SEARCH_Controller.php" method="post">
        ...
        <div class="SearchForm1">
            ...
            <div class="group">
                ...
                <input id="PorcentajeNota" name="PorcentajeNota" class="input" placeholder="DescripGrupo">
            </div>
            <div class="group">
