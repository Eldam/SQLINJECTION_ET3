...
class ImportationUser_SHOWALL_View
{
    var $response;
    ...
    function render(){
        ...
        <?php
        echo '<h1 style="color: white;padding-left: 100px ">Se han encontrado '.'<span style="color: red;">' .mysqli_num_rows($this->response).'</span> Entrega(s).</h1>';
        ?>
                    ...
                    while ($work = mysqli_fetch_array($this->response)){
                        if (strpos($work['IdTrabajo'], 'ET') !== false){
                            ...
                            echo"<td>".$work['IdTrabajo']."</td>".
                                ...
                                '<td><a href="../Controllers/ImportationUser_EDIT_Controller.php?value='.$work["IdTrabajo"].'"><i class="fa fa-pencil-square-o" id="modIcon"></i></td></a>'.
                                "</tr>";
                        }
