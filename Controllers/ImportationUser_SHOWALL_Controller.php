...
//esta autenticado
    ...
    if (!hasPermisionsTo("WORK","SEND")){
        ...
        $importationDAO = new ImportationDAO("");
        $resultado = $importationDAO->SEARCH();

        include_once '../Views/ImportationUser_SHOWALL_View.php';
        new ImportationUser_SHOWALL_View($resultado);
    }
}
