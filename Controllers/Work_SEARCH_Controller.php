...
//esta autenticado
    ...
    if (!hasPermisionsTo("WORK", "SEARCH")) {
        ...
        if (!isset($_REQUEST['IdTrabajo'])) {
            ...
            include_once '../Views/Work_SEARCH_View.php';
            new Work_SEARCH_View();
            ...
            $resultado = $work->SEARCH();

            include_once '../Views/Work_SHOWALL_View.php';
            new Work_SHOWALL_View($resultado);
